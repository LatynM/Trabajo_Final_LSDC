...
public class Ventana extends javax.swing.JFrame {
    ...
    public Ventana() {
        initComponents();
        logoIcon.setIcon(new ImageIcon("C:\\Users\\Marcelo\\Desktop\\tarea\\TUP 2022 2 CUATRIMESTRE\\LAB 2\\images\\logo.gif"));
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(eText, javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addComponent(rText, javax.swing.GroupLayout.Alignment.TRAILING)))
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    .addComponent(qText, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(pText, javax.swing.GroupLayout.PREFERRED_SIZE, 293, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void combate1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_combate1ActionPerformed
        ...
        /*
        Esto no sirve porque pide el valor de la segunda lista y está pidiendo eso en la primera donde no tiene 
        manera de sacarla
        Pero la idea base está
        ...
        for(Personaje champ: funcionCamp()){
            ...
            if(tipo1.equals("Asesino") && tipo2.equals("Soporte")){
                combateText.setText(nombre1+" gana contra "+nombre2);
            }
        }
*/
